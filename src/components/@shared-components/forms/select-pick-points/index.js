...
import {getPickupPoints} from "@/redux/slices/pickup-ponts-slice";


const DMTPickUpPoint = props => {
    const {
        onChange,
        fullWidth,
        name,
    ...
    const { pickupPoints } = useSelector(({ pickupPoint }) => pickupPoint );

    const fetchPickupPoints = async () => {
        await dispatch(getPickupPoints({}));
    }
                ...
                <Grid container spacing={2} alignItems={'center'}>
                    ...
                    <Grid item xs={12} sm={12} md={12}>
                        <Autocomplete
                            ...
                            value={getAutoCompleteValue(pickupPoints, value,'p_name')}
